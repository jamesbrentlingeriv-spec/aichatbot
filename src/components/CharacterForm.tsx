        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-3 py-2 bg-black border border-zinc-700 hover:bg-zinc-900 text-zinc-300 text-xs rounded-lg font-medium transition-colors whitespace-nowrap flex items-center gap-1.5 cursor-pointer"
            >
